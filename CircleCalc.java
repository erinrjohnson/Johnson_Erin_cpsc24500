...
/**
 *CircleCalc is a public class in which it makes it visible to the whole program.
 */
public class CircleCalc {
	/**This welcomeUser() function welcomes the user to my program. 
	 ...
	 * Then the result is printed in much the same way as my welcomeUser() function. 
	 */
